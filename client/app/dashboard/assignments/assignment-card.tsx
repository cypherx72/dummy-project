          ...
          <CarouselItem className="basis-1/3" key={i}>
            <Card className="gap-2 py-5 border-none w-full h-full overflow-hidden">
              ...
              <CardContent className="space-y-1.5 px-3">
                ...
                <Skeleton className="rounded-sm w-1/3 h-5" />
              </CardContent>
...
export default function AssignmentsCard() {
  ...
  return (
    <div className="flex flex-col flex-1 items-start gap-3 px-6 py-4 border-1 rounded-2xl h-full font-sans">
      <h3 className="flex flex-row items-center gap-1 font-semibold text-zinc-300 tracking-wide">
      ...
      <section className="flex flex-col justify-center items-center gap-2 w-full h-full">
        ...
        {!fetchAssignmentsLoading &&
          !fetchAssignmentsError &&
          assignments.length > 0 && (
            <Carousel className="px-6 w-full">
